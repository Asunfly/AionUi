...
vi.mock('@icon-park/react', () => ({
  ...
  Heartbeat: () => <span data-testid='icon-heartbeat' />,
...
vi.mock('@/renderer/components/settings/SettingsModal/contents/CloudBackupSettingsSection', () => ({
  default: () => <div data-testid='cloud-backup-settings-section' />,
}));
...
const systemModalDomHoisted = vi.hoisted(() => ({
...
vi.mock('@/common', () => ({
  ipcBridge: {
    ...
    systemSettings: {
      ...
      languageChanged: { on: (...args: any[]) => systemModalDomHoisted.languageChangedOn(...args) },
    },
    dialog: {
