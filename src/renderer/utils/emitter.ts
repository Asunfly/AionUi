...
interface EventTypes {
  ...
  'gemini.selected.file.appended': [Array<string | FileOrFolderItem>];
  ...
  'acp.selected.file.appended': [Array<string | FileOrFolderItem>];
  ...
  'codex.selected.file.appended': [Array<string | FileOrFolderItem>];
