...
export type I18nKey =
  ...
  | 'mcp.advancedOptions'
  | 'mcp.approve'
  | 'mcp.apps.enablePrompt'
  | 'mcp.apps.error'
  | 'mcp.apps.initTimeout'
  | 'mcp.apps.loading'
  | 'mcp.apps.rawData'
  | 'mcp.apps.settings.addTrust'
  | 'mcp.apps.settings.description'
  | 'mcp.apps.settings.enabled'
  | 'mcp.apps.settings.removeTrust'
  | 'mcp.apps.settings.title'
  | 'mcp.apps.settings.trustList'
  | 'mcp.apps.settings.trustListEmpty'
  | 'mcp.apps.trustPrompt'
  | 'mcp.capabilities'
  | 'mcp.connect'
  | 'mcp.connectedSince'
  | 'mcp.daysAgo'
