  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/renderer/components/settings/SettingsModal/contents/CloudBackupRemarkModal.tsx',
        'src/renderer/components/settings/SettingsModal/contents/CloudBackupRestoreModal.tsx',
        'src/renderer/components/settings/SettingsModal/contents/CloudBackupRestoreProgressModal.tsx',
        ...
        'src/process/services/backup/workspaceBackup.ts',
